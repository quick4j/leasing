                ...
                <div data-options="region:'north', split: false,border:false" style="height:150px;overflow: hidden;">
                    ...
                    <div style="overflow: hidden">
                        <table>
                            ...
                            <tr>
                                <td class="label">租借单位：</td>
                                <td>
                                    <input tabindex="2" id="leaser">
                                </td>
            ...
            var Order = (function(){
                var editingIndex = -1,
                            ...
                            columns:[[
                                ...
                                {field: 'oper', title: '操作', width: 80, halign: 'center',
                                    formatter: function(value,row,index){
                                        return '<div class="icon-remove" style="height: 16px; width: 16px; cursor: pointer;" title="删除当前行" onclick="Order.deleteItem('+index+')"></div>';
                                    }
                                }
                    ...
                    showSearchProjectDialog = function(){
                        ...
                        $.showModalDialog({
                            ...
                            onBeforeDestroy: function(){
                                $leaserPlugin.textbox('textbox').focus();
                                return true;
                            }
                        });
                    },
                    showSearchLeaserDialog = function(){
                        if($('#leaserDialog').length > 0) return;
                        $.showModalDialog({
                            id: 'leaserDialog',
                            title: '选择-租借单位',
                            width: 600,
                    ...
                    save = function(){
                        ...
                        $.ajax({
                            type: 'post',
                            url: 'leasing/orders/relet/out/new',
...
//                                    $('#tbBtnPrint').linkbutton('enable');
                                    location.href = 'leasing/orders/relet/out/'+data.data.id;
                                }else{
